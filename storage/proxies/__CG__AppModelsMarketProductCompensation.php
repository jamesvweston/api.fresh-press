 ...
 */
class ProductCompensation extends \App\Models\Market\ProductCompensation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductCompensation $proxy) {
