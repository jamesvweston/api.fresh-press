 ...
 */
class Campaign extends \App\Models\Market\Campaign implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', 'advertiser', 'created_at', 'updated_at', 'deleted_at'];
        }
